    ...
    var UsersView = (function (_super) {
        ...
        UsersView.prototype.config = function () {
            ...
            var headers = {
                ...
                padding: padding,
                cols: [
                    { view: "label", label: _("Role information") },
                    {
                        view: "icon",
                        icon: "wxi-pencil",
        ...
        DetailsView.prototype.config = function () {
            ...
            var headers = {
                ...
                cols: [
                    ...
                    { view: "label", label: _("Rule information") },
                    {},
                ],
            };
            var details = {
    ...
    var UsersView$3 = (function (_super) {
        ...
        UsersView.prototype.config = function () {
            ...
            var headers = {
                ...
                padding: padding,
                cols: [
                    { view: "label", label: this._("User information"), width: 125 },
                    {
                        view: "template",
